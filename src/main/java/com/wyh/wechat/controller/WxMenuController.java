...
public class WxMenuController implements WxMpMenuService {
  ...
  public String menuCreateSample() throws WxErrorException {
    ...
    btn1.setType(MenuButtonType.VIEW);
    btn1.setName("滞销莲藕");
    btn1.setUrl("http://v.qq.com/");

    WxMenuButton btn2 = new WxMenuButton();
    btn2.setType(MenuButtonType.VIEW);
    btn2.setName("野生葛粉");
    btn2.setUrl("http://v.qq.com/");

    WxMenuButton btn3 = new WxMenuButton();
    btn3.setType(MenuButtonType.VIEW);
    btn3.setName("滞销酥梨");
    btn3.setUrl("http://v.qq.com/");

    WxMenuButton btn4 = new WxMenuButton();
    btn4.setType(MenuButtonType.VIEW);
    btn4.setName("进入众筹");
    btn4.setUrl("http://v.qq.com/");

    button1.getSubButtons().add(btn1);
    button1.getSubButtons().add(btn2);
    button1.getSubButtons().add(btn3);
    button1.getSubButtons().add(btn4);
//
    WxMenuButton btn21 = new WxMenuButton();
    btn21.setType(MenuButtonType.VIEW);
    btn21.setName("仙女湖蜜");
    btn21.setUrl("http://www.soso.com/");

    WxMenuButton btn22 = new WxMenuButton();
    btn22.setType(MenuButtonType.VIEW);
    btn22.setName("古树红茶");
    btn22.setUrl("http://v.qq.com/");

    WxMenuButton btn23 = new WxMenuButton();
    btn23.setType(MenuButtonType.VIEW);
    btn23.setName("汤山酥梨");
    btn23.setUrl("http://v.qq.com/");


    WxMenuButton btn24 = new WxMenuButton();
    btn24.setType(MenuButtonType.VIEW);
    btn24.setName("温妈妈苹果");
    btn24.setUrl("http://v.qq.com/");

    WxMenuButton btn25 = new WxMenuButton();
    btn25.setType(MenuButtonType.VIEW);
    btn25.setName("进入商城");
    btn25.setUrl("http://www.soso.com/");

    button2.getSubButtons().add(btn21);
    button2.getSubButtons().add(btn22);
    button2.getSubButtons().add(btn23);
    button2.getSubButtons().add(btn24);
    button2.getSubButtons().add(btn25);
//
    WxMenuButton btn31 = new WxMenuButton();
    btn31.setType(MenuButtonType.VIEW);
    btn31.setName("农民求助");
    btn31.setUrl("http://www.soso.com/");

    WxMenuButton btn32 = new WxMenuButton();
    btn32.setType(MenuButtonType.VIEW);
    btn32.setName("商城订单");
    btn32.setUrl("http://v.qq.com/");

    WxMenuButton btn33 = new WxMenuButton();
    btn33.setType(MenuButtonType.VIEW);
    btn33.setName("众筹订单");
    btn33.setUrl("http://www.soso.com/");

    button3.getSubButtons().add(btn32);
    button3.getSubButtons().add(btn32);
    button3.getSubButtons().add(btn32);
